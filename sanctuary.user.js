...
(function() {
    ...
    class Sanctuary extends ws {
        constructor(){
            super('wss://project-private-server.glitch.me/moomoo'); // better? u happy now? its set to moomoo dipshit
        }
    }
    window.WebSocket = Sanctuary;

    // prevent server full messagesa
